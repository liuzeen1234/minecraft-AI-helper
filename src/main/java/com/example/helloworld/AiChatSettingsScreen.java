...
public class AiChatSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        // AI 权限设置按钮（最大工具调用轮数等权限相关配置移到此二级页面）
        this.addDrawableChild(ButtonWidget.builder(
                Text.literal(I18n.tr("settings.chat.permission_settings")),
                button -> this.client.setScreen(new AiPermissionSettingsScreen(this)))
